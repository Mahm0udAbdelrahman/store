            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <ul class="breadcrumb-nav">
                        <li><a href="{{ route('home') }}l"><i class="lni lni-home"></i> Home</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <input type="text" name="addr[billing][email]" placeholder="Email Address">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <input type="text" name="addr[billing][street_address]" placeholder="Mailing Address">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <input type="text" name="addr[billing][postal_code]" placeholder="Post Code">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Email Address</label>
                                                <div class="form-input form">
                                                    <input type="text" name="addr[shipping][email]" placeholder="Email Address">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                <label>Mailing Address</label>
                                                <div class="form-input form">
                                                    <input type="text" name="addr[shipping][street_address]" placeholder="Mailing Address">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Post Code</label>
                                                <div class="form-input form">
                                                    <input type="text" name="addr[shipping][postal_code]" placeholder="Post Code">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                        ...
                        <div class="checkout-sidebar-price-table mt-30">
                            ...
                            <div class="sub-total-price">
                                <div class="total-price">
                                    ...
                                    <p class="price">{{ App\Helpers\Currency::format($cart->total() ,'USD') }}</p>
                                </div>
